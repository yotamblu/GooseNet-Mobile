...
public class EditProfileMenuActivity extends AppCompatActivity {
    private Button changePasswordButton,changeProfilePicButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeProfilePicButton.setOnClickListener(v ->{
            Intent intent = new Intent(this,ChangeProfilePicActivity.class);
            startActivity(intent);
        });
    }
}